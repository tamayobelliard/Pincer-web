    ...
    const patchRes = await fetch(
      `${supabaseUrl}/rest/v1/shifts?id=eq.${shift_id}&restaurant_slug=eq.${encodeURIComponent(slug)}`,
      {
        ...
        body: JSON.stringify({
          ...
          ordenes_completadas: summary.ordenes_completadas,
          ordenes_canceladas: summary.ordenes_canceladas,
          total_bruto: summary.total_bruto,
          total_neto: summary.total_neto,
          fee_pincer: summary.fee_pincer,
          itbis: summary.itbis,
          total_efectivo: summary.total_efectivo,
          total_tarjeta: summary.total_tarjeta,
